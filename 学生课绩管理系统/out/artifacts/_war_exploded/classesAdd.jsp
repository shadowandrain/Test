...
<body>
<center>
    <font style="font-size: 30px;font-family: 楷体;color: red">新增班级</font>
    <form action="/myWeb/classes_add">
        <table border="1">
            <tr>
                <td>班级号</td>
            ...
            <tr>
                ...
                <td>
                    <select name="cour_time">
                        ...
                        <option value="Tues/1">星期二/一节</option>
                        <option value="Tues/2">星期二/二节</option>
                        <option value="Tues/3">星期二/三节</option>
                        <option value="Wed/1">星期三/一节</option>
                        <option value="Thurs/1">星期四/一节</option>
                        <option value="Thurs/3">星期四/三节</option>
                    </select>
                </td>
            </tr>
        </table>
